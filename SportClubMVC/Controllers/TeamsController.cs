...
namespace SportClubMVC.Controllers
{
    ...
    public class TeamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Coach,NumberOfPlayers,YearFounded")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Coach,NumberOfPlayers,YearFounded")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
